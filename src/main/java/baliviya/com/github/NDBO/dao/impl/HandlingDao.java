...
public class HandlingDao extends AbstractDao<Handling> {
    ...
    public void insertService(Handling handling) {
        sql = "INSERT INTO " + Const.TABLE_NAME + ".SERVICE (PHOTO, TEXT, SERVICE_TYPE_ID, FULL_NAME) VALUES ( ?,?,?,? )";
        getJdbcTemplate().update(sql, handling.getPhoto(), handling.getText(), handling.getHandlingTypeId(), handling.getFullName());
    }

    public void insertCourse(Handling handling) {
        sql = "INSERT INTO " + Const.TABLE_NAME + ".COURSE (PHOTO, TEXT, COURSE_NAME_ID, FULL_NAME) VALUES ( ?,?,?,? )";
        getJdbcTemplate().update(sql, handling.getPhoto(), handling.getText(), handling.getHandlingTypeId(), handling.getFullName());
    }

    public void insertTraining(Handling handling) {
        sql = "INSERT INTO " + Const.TABLE_NAME + ".TRAINING (PHOTO, TEXT, TRAINING_NAME_ID, FULL_NAME) VALUES ( ?,?,?,? )";
        getJdbcTemplate().update(sql, handling.getPhoto(), handling.getText(), handling.getHandlingTypeId(), handling.getFullName());
    }

    public void insertBusiness(Handling handling) {
        sql = "INSERT INTO " + Const.TABLE_NAME + ".BUSINESS (PHOTO, TEXT, BUSINESS_NAME_ID, FULL_NAME) VALUES ( ?,?,?,? )";
        getJdbcTemplate().update(sql, handling.getPhoto(), handling.getText(), handling.getHandlingTypeId(), handling.getFullName());
    }

    public void insertConsultation(Handling handling) {
        sql = "INSERT INTO " + Const.TABLE_NAME + ".CONSULTATION (PHOTO, TEXT, CONSULTATION_NAME_ID, FULL_NAME) VALUES ( ?,?,?,? )";
        getJdbcTemplate().update(sql, handling.getPhoto(), handling.getText(), handling.getHandlingTypeId(), handling.getFullName());
    }

    public void updateService(Handling handling) {
        sql = "UPDATE " + Const.TABLE_NAME + ".SERVICE SET FULL_NAME = ?, TEXT = ?, PHOTO = ? WHERE ID = ?";
    ...
    public void updateCourse(Handling handling) {
        sql = "UPDATE " + Const.TABLE_NAME + ".COURSE SET FULL_NAME = ?, TEXT = ?, PHOTO = ? WHERE ID = ?";
        getJdbcTemplate().update(sql, handling.getFullName(), handling.getText(), handling.getPhoto(), handling.getId());
    }

    public void updateTraining(Handling handling) {
        sql = "UPDATE " + Const.TABLE_NAME + ".TRAINING SET FULL_NAME = ?, TEXT = ?, PHOTO = ? WHERE ID = ?";
        getJdbcTemplate().update(sql, handling.getFullName(), handling.getText(), handling.getPhoto(), handling.getId());
    }
    ...
    public void updateConsultation(Handling handling) {
        sql = "UPDATE " + Const.TABLE_NAME + ".CONSULTATION SET FULL_NAME = ?, TEXT = ?, PHOTO = ? WHERE ID = ?";
        getJdbcTemplate().update(sql, handling.getFullName(), handling.getText(), handling.getPhoto(), handling.getId());
    }
